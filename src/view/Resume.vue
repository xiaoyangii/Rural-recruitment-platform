    ...
    <div class="profile">
      ...
      <div class="resumeForm">
        ...
        <div class="resumeViewSection">
          ...
          <h2 class="resumeViewSection__title">获奖情况</h2>
          <div
            :key="index"
...
export default {
  ...
  data() {
    return {
      resumeDetail: {
        name: "张凯权",
        mobile_number: 15860920147,
        email: "1210693637@qq.com",
        career_list: [
          {
            company: "大飒飒",
            start_time: "2010.2.10",
            end_time: "2010.2.10",
            title: "工人",
            description: "dfdafdafafasfsfsfa"
          }
        ]
      }
    };
  ...
  created() {
    ...
    request
      .post("/Resume/selectResumeBySelfOne", formDate)
      .then(res => {
        if (res.status == 200) {
          this.$message({
            message: "获取简历成功",
